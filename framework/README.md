...
CI lives at the repo root (`.github/workflows/tests.yml`) and runs this suite
headless on every push. A single-file, self-contained version of the same flow
lives in [`../standalone/`](../standalone/).
